...
class StageFactory:
    ...
    Main goal: avoid cyclic imports between stages.
    """
    ...
    def get_stage(stage_name: str) -> type[Stage]:
        ...
        if stage_name == "WaitAggregatedModelsStage":
        ...
        if stage_name == "GossipModelStage":
